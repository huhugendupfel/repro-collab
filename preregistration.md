...
A fundamental question in this field is: when something in the world changes by a certain amount, how much does our perception of it change? In 1877, Fechner— the founder of psychophysics—introduced his seminal theory on the perception of the physical world. He already anticipated that his theory would prevail for long time precisely because critics of theory would not find a way to agree on a unified approach to challenge it. Empirically, however, we think it should be consensually acceptable that his theory could be challenged by trying to replicate an original experiment from the time.
...
- **Computer and monitor**: The computer runs the experiment which presents visual stimuli for precisely controlled durations
...
3. We conduct trials.
   ...
   - Total: approximately 500 trials per participant
